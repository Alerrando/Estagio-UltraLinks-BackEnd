        ...
        <>
            ...
            <main className="w-screen h-[calc(100vh-_64px)] grid grid-cols-login mt-[64px]">
                <aside className="w-full h-full">
                    <img src="/public/aside-login.svg" alt="" className="w-10/12 h-full mx-auto" />
                </aside>
                ...
                <div className="w-full h-5/6 flex flex-col items-center my-auto px-8 gap-8 divide-y-2">
                    ...
                    <form className="h-full w-full grid grid-cols-inputs-register pt-4" onSubmit={handleSubmit(submit)}>
                        ...
                        <div className="w-full h-auto flex items-center justify-end col-span-2">
                            <button type="submit" className="border border-[#00938c] text-[#00938c] py-2 px-6 rounded-lg hover:bg-[#00938c] hover:text-white transition-all">
                                Cadastrar-se
                            </button>
                        </div>
                    </form>
